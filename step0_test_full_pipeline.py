...
Saves synthetic data to 'produced_data/' and runs through the full pipeline
"""
...
def generate_synthetic_data(n_samples=1000, n_dims=512, n_classes=2):
    ...
    Saves synthetic data to 'produced_data/'
    """
...
def create_test_data(out_dir='/home/markusbredberg/Scripts/parallelised_knn_classifier/produced_data'):
    """
    ...
    if rank == 0:
        ...
        print(f"✓ Created training data: {out_dir}/train_embeddings.npz")
        ...
        print(f"✓ Created test data: {out_dir}/test_embeddings.npz")
